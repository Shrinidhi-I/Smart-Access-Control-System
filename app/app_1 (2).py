...
def send_email(event_type):
    url = "https://api.emailjs.com/api/v1.0/email/send"
    
    # This is the payload data
    payload = {
        'service_id': 'service_hh352bm',
        'template_id': 'template_639vliw',
        'user_id': 'h7ma3KDUemAnmp-G6',  # Your public key
        'accessToken': 'gsbPPe0x_NnwrC2KU85T0',  # Add your private key here
        'template_params': {
    ...
    while True:
        # if download_image_from_url(local_target_image_url, local_image_path):
            ...
            if compare_faces(local_image_path, faces_folder):
                ...
                # send_email('Access Granted')  # Sending email
                ...
                # send_email('Access Denied')  # Sending email
                time.sleep(5)
                break
        # else:
